...
entity PmodKYPD is
    Port ( 
          clk : in  STD_LOGIC;
          JA : inout  STD_LOGIC_VECTOR (7 downto 0); -- PmodKYPD is designed to be connected to name 
          decoding : out std_logic_vector (3 downto 0)
...
begin
    ...
    C0: Decoder port map (clk=>clk, Row =>JA(7 downto 4), Col=>JA(3 downto 0), DecodeOut=> decoding);
